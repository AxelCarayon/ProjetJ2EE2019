 ...
 * @author Axel
 */
@WebServlet(name = "ProduitsCategoriesServlet", urlPatterns = {"/ProduitsCategorieServlet"})
public class ProduitsCategorieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProduitsCategorieServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
